...
import 'package:edtech/ui/screens/memory_lab/view_memory_lab_screen.dart';
import 'package:flutter/material.dart';

class MemoryLabScreen extends StatefulWidget {
  @override
  MemoryLabScreenState createState(){
    return MemoryLabScreenState();
  }
}

class MemoryLabScreenState extends State<MemoryLabScreen>
{
  @override
                          ...
                          child: GestureDetector(
                            onTap: (){
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context) => ViewMemoryLabScreen())
                              );
                            },
                            child: Row(
