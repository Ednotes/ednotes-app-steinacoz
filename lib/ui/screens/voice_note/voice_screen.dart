// import 'package:edtech/Screens/view_voice_screen.dart';

import 'package:edtech/ui/screens/voice_note/view_voice_screen.dart';
import 'package:flutter/material.dart';

class VoiceScreen extends StatefulWidget {
  @override
  VoiceScreenState createState(){
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context,
                                    MaterialPageRoute(builder: (context) => ViewVoiceScreen())
                                );
                              },
                              child: Row(
